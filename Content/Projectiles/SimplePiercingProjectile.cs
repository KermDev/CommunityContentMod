...
{
	/// <summary>
	/// Ported from my mod, feel free to use it<br/>
	/// Ai0 : shoot velocity<br/>
	/// Ai1 : time left of a AI, recommend setting it above 0<br/>
	/// Ai2 : Do not touch ai2
	/// </summary>
	public class Xinim_SimpleProjectile : ModProjectile
	{
		public Color ProjectileColor = Color.White;
		public override string Texture => CCModTool.GetVanillaTexture<Projectile>(ProjectileID.PiercingStarlight);
